...
Welcome to Rebase #26! If you've got an interesting project you'd like to see on the column feel free to shoot me a message. I'd love to see more themed Rebase columns, like the "book edition":http://rebase.github.com/22.html. Perhaps we could have a JSON edition, a hardcore C edition, unknown language edition, and so on. I follow some simple guidelines that you can check out "here":http://rebase.github.com/howto.html too.
