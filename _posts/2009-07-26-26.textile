...
Welcome to Rebase #26! If you've got an interesting project you'd like to see on the column feel free to shoot me a message. This week was a little HTTP heavy, which is fine for webdevs like myself but I'd like to see some more diversity. I follow some simple guidelines that you can check out "here":http://rebase.github.com/howto.html too.
