...
*"weary":http://github.com/mwunsch/weary/tree/master* souls need REST, according to this library. Think of this library as the after-"HTTParty":http://github.com/jnunemaker/httparty/. The DSL for declaring a HTTP resource is extremely clean, and it's really simple to dive down and tinker with the details if necessary. This gem also uses "Crack":http://github.com/jnunemaker/crack/tree/master to parse json and xml that your webservice du jour provides.
