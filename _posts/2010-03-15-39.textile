...
*"LastHistory":http://github.com/triplef/LastHistory* is an OSX visualizer for your "Last.fm":http://last.fm history that explores the music you have listened to in whole new ways. Using analysis mode you can "dive into your history":http://lasthistory.tumblr.com/post/392969009/introducing-lasthistory,
...
You could also jump into Personal mode, which overlays your photos and calendar entries on top of your history. Check out a video demo and plenty of screenshots on the "project's website":http://www.frederikseiffert.de/lasthistory/.

*"phake":http://github.com/jaz303/phake* is a make/rake clone in PHP. Set up a <code>Phakefile</code>, drop a <code>task 'foo'</code> and run it with <code>phake foo</code>. You can set up dependencies for tasks, group them together logically, list tasks with @phake -T@, and there's even "Capistrano":http://www.capify.org/index.php/Capistrano like <code>before</code> and <code>after</code> hooks. If you're a PHP developer and would rather write PHP to help with automated tasks in your web app, check this project out. Just remember, "language geeks love PHP too!":http://twitter.com/bmabey/status/10380462742

*"html-minifier":http://github.com/kangax/html-minifier* is an extreme steamroller for your HTML that you can "play with here":http://kangax.github.com/html-minifier/. The author has taken web optimization to the next level with plenty of research into what "bloats your pages":http://perfectionkills.com/optimizing-html/, including everything from useless comments, archaic markup habits, whitespace, and more. You can read up about how the parser and minifer works "here":http://perfectionkills.com/experimenting-with-html-minifier/#how_it_works on the author's blog. For large production websites every kilobyte counts, and a command line implementation of this or even web frontend version would help with saving everyone some bandwidth.
